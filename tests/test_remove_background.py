...
with tempfile.TemporaryDirectory() as td:
    ...
    (ws / "_attachments").mkdir()
    src.save(ws / "_attachments" / "att.jpg")
    ...
    check("error: missing file names list_dir and _attachments", code == 1 and "not found" in out and "list_dir" in out and "_attachments" in out, out)
